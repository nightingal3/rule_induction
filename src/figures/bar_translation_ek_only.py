...
# Filter the DataFrame for a specific direction 'ek'
df_filtered = df[df['lang_direction'] == 'ek']
...
plt.savefig("./src/figures/mtob_baselines_ek_direction.png")
plt.savefig("./src/figures/mtob_baselines_ek_direction.pdf")
