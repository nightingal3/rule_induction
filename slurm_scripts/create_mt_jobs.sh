            ...
            for temp in ${temps[@]}; do
                if [ $prompt_type == "grammar_induction" ]; then
                    ...
                    for method in ${rerank_by[@]}; do
                        out_path="mtob/baselines/logs/kalamang/${direction}/${model}/${prompt_type}/${method}/temp_${temp}/n_hyps_$nhyps/$run_num"
                        nhyps=5
                        ...
                        script_args="--use_reference_sentences --induce_wordlist --use_induced_grammar --grammar_sketch_path ../resources/kalamang_grammar_sketch_${model}.txt  --n_hyps 5 --rerank_hyps_method ${method}"
                    ...
                    out_path="mtob/baselines/logs/kalamang/${direction}/${model}/${prompt_type}/temp_${temp}/$run_num"
